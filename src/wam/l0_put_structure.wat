...
;)
    ...
    (func $query2_3
        (call $putStructure (global.get $predH_2) (i32.const 3))
        (call $setVariable (i32.const 2))
        (call $setVariable (i32.const 5))
        (call $putStructure (global.get $predF_1) (i32.const 4))
        (call $setValue (i32.const 5))
        (call $putStructure (global.get $predP_3) (i32.const 1))
        (call $setValue (i32.const 2))
        (call $setValue (i32.const 3))
        (call $setValue (i32.const 4))
    )

   (func $program2_4
        (call $getStructure (global.get $predP_3) (i32.const 1))
        (call $unifyVariable (i32.const 2))
        (call $unifyVariable (i32.const 3))
        (call $unifyVariable (i32.const 4))
        (call $getStructure (global.get $predF_1) (i32.const 2))
        (call $unifyVariable (i32.const 5))
        (call $getStructure (global.get $predH_2) (i32.const 3))
        (call $unifyValue (i32.const 4))
...
;)
    ...
    (export "program2_4" (func $program2_4))
    (export "program2_4a" (func $program2_4a))
    (export "program2_4b" (func $program2_4b))
)
