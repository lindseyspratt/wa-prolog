...
function setupForeigns(commonHostData) {
    foreign.hostData = commonHostData;
    hostData.registerForeign('get_byte', foreign.predicate_get_byte);
}
